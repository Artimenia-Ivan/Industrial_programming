...
public abstract class AbstractStorage<T> {
    ...
    public abstract List<VagonDTO> readFromXml(String filename);
    public abstract void writeToXml(String filename, List<VagonDTO> cakes);
    public abstract void writeDataToJsonFile(String filename,List<VagonDTO> cakes);
    public abstract List<VagonDTO> readDataFromJsonFile(String filename);
    public abstract void setListStorage(List<VagonDTO> vagonDTOS);
    //C/U
